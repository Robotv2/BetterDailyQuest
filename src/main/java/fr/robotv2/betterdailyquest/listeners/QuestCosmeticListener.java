...
import fr.robotv2.betterdailyquest.configurations.cosmetics.CosmeticType;
import fr.robotv2.betterdailyquest.configurations.cosmetics.Cosmeticable;
import fr.robotv2.betterdailyquest.configurations.cosmetics.impl.ActionBarTitlesSection;
...
import fr.robotv2.betterdailyquest.util.ListActionProcessor;
...
public class QuestCosmeticListener implements Listener {
    ...
    public QuestCosmeticListener(BetterDailyQuest plugin) {
        this.plugin = plugin;
    }
