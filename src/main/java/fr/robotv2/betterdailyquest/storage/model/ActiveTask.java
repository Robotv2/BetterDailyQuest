...
public class ActiveTask implements java.io.Serializable, DirtyAware {
    ...
    public ActiveTask(ActiveTaskDto dto) {
        this.activeTaskUniqueId = dto.getId();
    ...
    public Task getTask() {
        return BetterDailyQuest.instance().getQuestManager().fromId(parentQuestId, parentQuestGroupId).getTask(taskId);
    }
