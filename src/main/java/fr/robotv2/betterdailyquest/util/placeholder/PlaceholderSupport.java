...
import fr.robotv2.betterdailyquest.util.placeholder.impl.RelationalValuePlaceholder;
import fr.robotv2.betterdailyquest.util.placeholder.impl.SimplePlaceholder;
import fr.robotv2.betterdailyquest.util.placeholder.impl.SuppliedPlaceholder;
...
public abstract class PlaceholderSupport<E extends PlaceholderSupport<E>> {
    ...
    public E color() {
        return apply((text) -> BetterDailyQuest.instance().getColorProvider().colorize(text));
    }
}
