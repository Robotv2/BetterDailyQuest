package fr.robotv2.betterdailyquest.quest.type;
...
public class QuestType<T> {
    ...
    public void registerListener() throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        final Constructor<? extends QuestProgressionEnhancer> cstr = listener.getDeclaredConstructor(BetterDailyQuest.class);
        final QuestProgressionEnhancer enhancer = cstr.newInstance(BetterDailyQuest.instance());
        Bukkit.getPluginManager().registerEvents(enhancer, BetterDailyQuest.instance());
    }
