...
[Download 0.0.7 Beta](https://github.com/Robotv2/BetterDailyQuest/releases/tag/v0.0.7){ .md-button }
...
Version 0.0.7 Beta has passed startup and clean-shutdown checks on Paper 1.8.8 and Paper 26.1.2. Its player-facing behavior is unchanged from the Quest Board, Stonebreaker completion, reload, reconnect, and persistence checks performed for version 0.0.6. These checks do not prove every task type or integration.
