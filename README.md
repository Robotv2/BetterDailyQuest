...
The current public version is [0.0.10 Beta](https://github.com/Robotv2/BetterDailyQuest/releases/tag/v0.0.10).

## Administrator guide

The public guide is published at **<https://robotv2.github.io/BetterDailyQuest/>** and follows the latest tagged GitHub release.

- [Install BetterDailyQuest](https://robotv2.github.io/BetterDailyQuest/getting-started/installation/)
...
- [Manage a server](https://robotv2.github.io/BetterDailyQuest/administration/)
- [Download 0.0.10 Beta](https://github.com/Robotv2/BetterDailyQuest/releases/tag/v0.0.10)
...
Administrator-visible changes must update the guide in the same pull request. See [CONTRIBUTING.md](CONTRIBUTING.md) for the documentation contract and local validation commands.
