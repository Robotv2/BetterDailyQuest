...
The current public beta is available from [GitHub Releases](https://github.com/Robotv2/BetterDailyQuest/releases).
...
- [Download the current beta](https://github.com/Robotv2/BetterDailyQuest/releases)
